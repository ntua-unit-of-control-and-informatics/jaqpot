...
export class SocialBaseComponent implements OnInit {
  ...
  constructor(
    ...
    this.websiteURL = new FormControl({value: '', disabled: true}, Validators.required)
    this.githubURL = new FormControl({value: '', disabled: true}, Validators.required)
    this.linkedinURL = new FormControl({value: '', disabled: true}, Validators.required)
    this.twitterURL = new FormControl({value: '', disabled: true}, Validators.required)
